...
public class CalculateArea {
    ...
    public static void calculateCircleArea() {
        ...
        if (radius.compareTo(BigDecimal.ZERO) <0){
            throw new RuntimeException("Radius can't be less than 0");
        }else{
            // Display output
    ...
    public static void calculateRectangleArea() {
        ...
        if (length.compareTo(BigDecimal.ZERO) <0 || width.compareTo(BigDecimal.ZERO) <0 ){
            throw new RuntimeException("Length and width can't be less than 0");
        }else{
            // Display output
    ...
    public static void calculateTriangleArea() {
        ...
        if (base.compareTo(BigDecimal.ZERO) <0 || height.compareTo(BigDecimal.ZERO) <0 ){
            throw new RuntimeException("Base and height can't be less than 0");
        }else{
